...
/*
The ADCS module uses quaternion-based calculations for precise spacecraft orientation. 
...
void ADCS::update() {
    std::cout << "ADCS Stabilizing Attitude..." << std::endl;
}

void ADCS::adjustOrientation(double roll, double pitch, double yaw) {
    std::cout << "Adjusting Orientation - Roll: " << roll << "°, Pitch: " << pitch << "°, Yaw: " << yaw << "°" << std::endl;
}
